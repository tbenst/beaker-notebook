module.exports = [
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-07_Citi_Bike_trip_data.csv",
      rows: 843416,
      format: "CSV",
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-08_Citi_Bike_trip_data.csv",
      rows: 1001958,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-09_Citi_Bike_trip_data.csv",
      rows: 1034359,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-10_Citi_Bike_trip_data.csv",
      rows: 1037712,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-11_Citi_Bike_trip_data.csv",
      rows: 675774,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2013-12_Citi_Bike_trip_data.csv",
      rows: 443966,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-01_Citi_Bike_trip_data.csv",
      rows: 300400,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-02_Citi_Bike_trip_data.csv",
      rows: 224736,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-03_Citi_Bike_trip_data.csv",
      rows: 439117,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-04_Citi_Bike_trip_data.csv",
      rows: 670780,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-05_Citi_Bike_trip_data.csv",
      rows: 866117,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-06_Citi_Bike_trip_data.csv",
      rows: 936880,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-07_Citi_Bike_trip_data.csv",
      rows: 968842,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/2014-08_Citi_Bike_trip_data.csv",
      rows: 963489,
      format: "CSV",
      updateFrequency: "Monthly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      remoteFile: "/var/s3/Citi_Bike_Ridership_and_Membership_Data_Launch-Sept2013.csv",
      rows: 127,
      format: "CSV",
  ...
  },
  {
    ...
    data: {
      ...
      description: "Citi Bike Daily Ridership and Membership Data. Info includes the number of trips over the last 24 hours, cumulative trips, miles traveled , total memberships sold and more.",
      remoteFile: "/var/s3/Citi_Bike_Ridership_and_Membership_Data_Oct-Dec2013.csv",
      rows: 92,
      format: "CSV",
      updateFrequency: "Quarterly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      description: "Citi Bike Daily Ridership and Membership Data. Info includes the number of trips over the last 24 hours, cumulative trips, miles traveled , total memberships sold and more.",
      remoteFile: "/var/s3/Citi_Bike_Ridership_and_Membership_Data_Jan-Mar2014.csv",
      rows: 90,
      format: "CSV",
      updateFrequency: "Quarterly",
      metadata: {
  ...
  },
  {
    ...
    data: {
      ...
      description: "Citi Bike Daily Ridership and Membership Data. Info includes the number of trips over the last 24 hours, cumulative trips, miles traveled , total memberships sold and more.",
      remoteFile: "/var/s3/Citi_Bike_Ridership_and_Membership_Data_Apr-June2014.csv",
      rows: 91,
      format: "CSV",
      updateFrequency: "Quarterly",
      metadata: {
